...
/////////////////////////////////
	...
	$("#formCadastro").validate({
		rules: {
			clie_name: "required",
			clie_last_name: "required",
			clie_cpf: {
				required: true,
				cpf: "both"
			},
			clie_birth: "required",
			clie_company_name: "required",
			clie_company_resp: "required",
			clie_company_cnpj: {
				required: true,
				cnpj: "both"
			},
			...
			clie_local_name: "required",
			clie_zip: "required",
			clie_address: "required",
			clie_address_num: "required",
			clie_state: "required",
			clie_city: "required",
			clie_district: "required",
			clie_phone_01: "required"
		},
		messages: {
			clie_name: "Este campo deve ser preenchido",
			clie_last_name: "Este campo deve ser preenchido",
			clie_cpf: {
				required: "Este campo deve ser preenchido",
				cpf: "Digite um CPF válido"
			},
			clie_birth: "Este campo deve ser preenchido",
			clie_company_name: "Este campo deve ser preenchido",
			clie_company_resp: "Este campo deve ser preenchido",
			clie_company_cnpj: {
				required: "Este campo deve ser preenchido",
			...
			clie_local_name: "Este campo deve ser preenchido",
			clie_zip: "Este campo deve ser preenchido",
			clie_address: "Este campo deve ser preenchido",
			clie_address_num: "Este campo deve ser preenchido",
			clie_state: "Este campo deve ser preenchido",
			clie_city: "Este campo deve ser preenchido",
			clie_district: "Este campo deve ser preenchido",
			clie_phone_01: "Este campo deve ser preenchido"
		}
	});
